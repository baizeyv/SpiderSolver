...
private:
    ...
    // #region doodle test
    Solver* doodle_batch_solver;
    std::unique_ptr<std::thread> doodle_batch_thread;
    std::atomic<bool> doodle_batch_thread_done = false;
    bool doodle_batch_stop_flag = false;
};
